...
banner:
  content: |
    2/25 12:30 頒布開始まであと <countdown-timer class="countdown" data-target="2026-02-25T12:30:00+09:00"></countdown-timer>
hero:
...
2/25 12:30からZaruBallのみ15台を頒布します。Mackは頒布いたしません。
:::

<div style={{ display: 'flex', justifyContent: 'center' }}>

| 名称                               | 金額     | 在庫数(2/25 12:30～) | 予約注文残数 |
| ---------------------------------- | -------- | -------------------- | ------------ |
| ZaruBallキット(ホワイト)           | 20,000円 | 15                   | 0            |
